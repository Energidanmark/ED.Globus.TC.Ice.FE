...
namespace ED.Atlas.Svc.TC.Ice.FE.Trades
{
    public class MessageConstructor
    {
        ...
        //public MessageConstructor(string username, string password, string senderCompID, string senderSubID, string targetCompID)
        //{
        //    _username = username;
        //    _password = password;
        ...
        //public string TradeCaptureReportRequest(SessionQualifier qualifier,int messageSequenceNumber, int uniqueTradeRequestId)
        //{
        //    var body = new StringBuilder();
        //    //body.Append("263=" + 0 + "|"); // SubscriptionType. 0 for snapshot.
            
        //    body.Append("568=" + uniqueTradeRequestId + "|"); //Unique quote request id. New ID for a new subscription, same one as previously used for subscription removal.

        //    //body.Append("569=" + 0 + "|"); // 0 for all trades.
        //    body.Append("263=" + 1 + "|"); // 1 for snapshot + Update
            
        //    body.Append("453=" + 1 + "|"); // NoPartyIds - NumInGroup  // from 1
        //    body.Append("448=" + 13379 + "|"); // PartyID
        //    body.Append("447=" + "D" + "|"); // PartyIDSource
        //    body.Append("452=" + 3 + "|"); // PartyRole. Not sure if actually 3 or company Id

        //    body.Append("580=" + 1 + "|"); // NoDates - Use Transact and/or TradeTime
            

        //    var dt = DateTime.Today.ToString("yyyyMMdd-hh:mm:ss");
        //    // 60 = TransactTime, 75=TradeDate
        //    body.Append("75=" + DateTime.Today.ToString("yyyyMMdd") + "|"); 
        //    body.Append("60=" + dt + "|"); 

        //  var header = ConstructHeader(qualifier, ApplicationMessageCode(ApplicationMessageType.TradeCaptureReportRequest), messageSequenceNumber, body.ToString());
        //    var headerAndBody = header + body;
        //    var trailer = ConstructTrailer(headerAndBody);
        //    var headerAndMessageAndTrailer = header + body + trailer;
        //    return headerAndMessageAndTrailer.Replace("|", "\u0001");
        ...
        ///// <returns></returns>
        //public string MarketDataRequestMessage(SessionQualifier qualifier, int messageSequenceNumber, string marketDataRequestID, int subscriptionRequestType, int marketDepth, int marketDataEntryType,
        //    int noRelatedSymbol, long symbol = 0)
        //{
        //    var body = new StringBuilder();
        ...
        ///// <param name="marketDataRequestID">Unique quote request id. New ID for a new subscription, same one as previously used for subscription removal.</param>
        ///// <returns></returns>
        //public string MarketDataSnapshotMessage(SessionQualifier qualifier, int messageSequenceNumber, long symbol, string noMarketDataEntries, int entryType, decimal entryPrice,
        ...
        ///// <param name="symbol">/Instrument identificators are provided by Spotware.</param>
        ///// <returns></returns>
        //public string MarketDataIncrementalRefreshMessage(SessionQualifier qualifier, int messageSequenceNumber, string marketDataRequestID, int noMarketDataEntries, int marketDataUpdateAction,
        //    int marketDataEntryType, string marketDataEntryID, int noRelatedSymbol, decimal marketDataEntryPrice = 0, double marketDataEntrySize = 0, long symbol = 0)
        //{
        //    var body = new StringBuilder();
        //    //Unique quote request id. New ID for a new subscription, same one as previously used for subscription removal.
        //    body.Append("262=" + marketDataRequestID + "|");
        ...
        ///// <returns></returns>
        //public string NewOrderSingleMessage(SessionQualifier qualifier, int messageSequenceNumber, string orderID, long symbol, int side, string transactTime, int orderQuantity, int orderType,
        //    string timeInForce, decimal price = 0, decimal stopPrice = 0, string expireTime = "", string positionID = "")
        //{
        //    var body = new StringBuilder();
        ...
        ///// <returns></returns>
        //public string BusinessMessageReject(SessionQualifier qualifier, int messageSequenceNumber, int referenceSequenceNum = 0, string referenceMessageType = "", string businessRejectRefID = "",
        //    int businessRejectReason = -1, string text = "")
        //{
        //    var body = new StringBuilder();
        ...
        //    string formatted = message.Replace("|", "\u0001").ToString().ToString().PadLeft(3, '0') + "|";
        ...
        //            return "AN";
        //            break;
        //        case ApplicationMessageType.TradeCaptureReportRequest:
        //            return "AD";
        //            break;
